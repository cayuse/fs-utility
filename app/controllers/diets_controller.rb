class DietsController < ApplicationController
  ...
  # GET /diets.json
  def index
    @diets = Diet.includes(:dietdocuments)
  end
  ...
  # GET /diets/new
  def new
    @diet = Diet.new(:schoolyear_id => params[:schoolyear_id], :student_id => params[:student_id])
  end
  ...
  def create
    ...
    respond_to do |format|
      if @diet.save
        format.html { redirect_to @diet.student, notice: 'Diet was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @diet.update(diet_params)
        format.html { redirect_to @diet.student, notice: 'Diet was successfully updated.' }
  ...
  private
    ...
    def diet_params
      params.require(:diet).permit(:student_id, :schoolyear_id,
                                  {:diagnoses_attributes => [:id, :category_id, :condition_id]})
